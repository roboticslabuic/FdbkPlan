...
context_interactions = {
    ...
    'Mirror': 'Automatically breaks if subjected to enough force. For example, if an object thrown at it has enough force, the object may break.',
    ...
    'ShowerDoor': 'Automatically breaks if subjected to enough force. For example, if an object thrown at it has enough force, the object may break.',
    'ShowerGlass': 'Automatically breaks if subjected to enough force. For example, if an object thrown at it has enough force, the object may break.',
    'ShowerHead': 'Can be turned on with ToggleObjectOn action. When on, a stream of running water will pour out from the ShowerHead. For objects that can be automatically cleaned, the stream of water is a Running Water Source.',
